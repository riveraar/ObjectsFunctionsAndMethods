...
#            window = rg.RoseWindow(400, 400, 'Constructing a RoseWindow')
#
...
#                clone(), get_bounding_box(), and __init__()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                Radius, center, and fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Although you create objects in the windows provided, they aren't drawn until the window itself is rendered
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When you want to see what is inside the window without it having to quickly disappear
#
